...
- Password reset endpoints store only token hashes and must not return plaintext reset tokens.
...
|---|---|
| Admin catalog read and provider readiness | `catalog.view` |
| Admin catalog create/update | `catalog.manage` |
