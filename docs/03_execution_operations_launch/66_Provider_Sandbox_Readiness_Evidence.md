...
- provider-controlled redacted runtime example for cancel/delete rejected;
...
- redacted examples for auth, rate limit, validation, timeout, provider 5xx, and cancel/delete rejected errors;
