...
| Support SOP readiness | `partial` | SOP docs exist; T201 support/abuse backend basics merged; T200 notification foundation exists. T210 defines the notification/fallback evidence fields, and T222 defines the manual fallback runbook packet. | Assign support owner/coverage and prove production notification delivery or approved manual fallback. |
