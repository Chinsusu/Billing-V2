...
Single-owner risk: accepted for owner assignment, T244 notification manual fallback, T245 target evidence sign-off, T252 usable-status semantics, and T253 cleanup owner/procedure only; remaining P0 evidence gates still decide GO/NO-GO.
