...
Single-owner risk: accepted for owner assignment, T244 notification manual fallback, and T245 target evidence sign-off only; remaining P0 evidence gates still decide GO/NO-GO.
