...
Run result:
PASS for T249 duplicate/timeout, T250 safe error examples, and T256 permission-denied evidence in approved target dev/test. Broader pilot still blocked.
...
T250 safe error evidence is recorded in doc 66. T255 provider-controlled error plan and T256 permission-denied runtime evidence are recorded in doc 77.
