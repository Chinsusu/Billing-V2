...
Ops sign-off:
Admin for T267 protected systemd runtime evidence and T270 selected launch-window ops health evidence. Pause the selected pilot on health/readiness failure, secret exposure signal, or unavailable support coverage.
QA sign-off:
