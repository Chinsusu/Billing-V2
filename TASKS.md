...
Current board snapshot on `2026-04-26` while T171 is in progress:

- `TODO`: 0
- `IN_PROGRESS`: 1
- `REVIEW`: 0
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 167
...
| --- | --- | --- | --- | --- | --- |
| T171 | [tasks/active/T171_split_service_mocks.md](tasks/active/T171_split_service_mocks.md) | IN_PROGRESS | Codex | codex/t171-split-service-mocks | Split service mock data out of billingData. |
