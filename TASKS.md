...
Current board snapshot on `2026-04-26` after T160 PR was opened:
...
| --- | --- | --- | --- | --- | --- |
| T160 | [tasks/active/T160_reseller_catalog_label_cleanup.md](tasks/active/T160_reseller_catalog_label_cleanup.md) | REVIEW | Codex | codex/t160-reseller-catalog-labels | Show readable reseller catalog source/status labels. |
