...
Current board snapshot on `2026-04-26` after T136 is in review:

- `TODO`: 0
- `IN_PROGRESS`: 0
- `REVIEW`: 1
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 132
...
| --- | --- | --- | --- | --- | --- |
| T136 | [tasks/active/T136_client_topup_public_prefix.md](tasks/active/T136_client_topup_public_prefix.md) | REVIEW | Codex | codex/t136-client-topup-prefix | Align client top-up public ID prefix. |
