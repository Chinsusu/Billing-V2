...
Current board snapshot on `2026-05-17` with T235 in progress:
...
| --- | --- | --- | --- | --- | --- |
| T235 | [tasks/active/T235_topup_review_e2e_evidence.md](tasks/active/T235_topup_review_e2e_evidence.md) | IN_PROGRESS | Codex | codex/t235-topup-review-e2e | Prove target top-up review create/approve/reject E2E evidence without provider provisioning. |
