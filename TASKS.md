...
Current board snapshot on `2026-05-16` with T226 in progress:
...
| --- | --- | --- | --- | --- | --- |
| T226 | [tasks/active/T226_cloudmini_mutating_pilot_preflight.md](tasks/active/T226_cloudmini_mutating_pilot_preflight.md) | IN_PROGRESS | Codex | codex/t226-cloudmini-mutating-pilot-preflight | Add non-mutating Cloudmini pilot preflight guard for owner, quota, cleanup, and mapping evidence. |
