...
Current board snapshot on `2026-05-18` after T253 creation:
...
| --- | --- | --- | --- | --- | --- |
| T253 | [tasks/active/T253_cloudmini_cleanup_owner.md](tasks/active/T253_cloudmini_cleanup_owner.md) | IN_PROGRESS | Codex | codex/t253-cloudmini-cleanup-owner | Record Cloudmini cleanup owner and rollback procedure for pilot scope. |
