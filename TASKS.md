...
Current board snapshot on `2026-04-26` while T170 is in progress:
...
| --- | --- | --- | --- | --- | --- |
| T170 | [tasks/active/T170_service_fallback_smoke.md](tasks/active/T170_service_fallback_smoke.md) | IN_PROGRESS | Codex | codex/t170-service-fallback-smoke | Cover admin service fallback labels in smoke. |
