...
Current board snapshot on `2026-04-27` while T176 is in progress:

- `TODO`: 0
- `IN_PROGRESS`: 1
- `REVIEW`: 0
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 172
...
| --- | --- | --- | --- | --- | --- |
| T176 | [tasks/active/T176_split_smoke_fallback_flows.md](tasks/active/T176_split_smoke_fallback_flows.md) | IN_PROGRESS | Codex | codex/t176-split-smoke-fallback-flows | Split admin smoke fallback flows below file-size risk threshold. |
