...
Current board snapshot on `2026-04-26` after T130 is in review:

- `TODO`: 0
- `IN_PROGRESS`: 0
- `REVIEW`: 1
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 126
...
| --- | --- | --- | --- | --- | --- |
| T130 | [tasks/active/T130_reseller_public_id_labels.md](tasks/active/T130_reseller_public_id_labels.md) | REVIEW | Codex | codex/t130-reseller-public-id-labels | Clean up reseller-facing labels to use public IDs. |
