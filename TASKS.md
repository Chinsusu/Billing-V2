...
Current board snapshot on `2026-04-26` after T133 is in review:

- `TODO`: 0
- `IN_PROGRESS`: 0
- `REVIEW`: 1
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 129
...
| --- | --- | --- | --- | --- | --- |
| T133 | [tasks/active/T133_reseller_remove_backend_reference_fallbacks.md](tasks/active/T133_reseller_remove_backend_reference_fallbacks.md) | REVIEW | Codex | codex/t133-reseller-remove-backend-fallbacks | Remove reseller backend-reference label fallbacks. |
