...
Current board snapshot on `2026-05-18` after T257 claim:
...
| --- | --- | --- | --- | --- | --- |
| T257 | [tasks/active/T257_cloudmini_out_of_capacity_evidence.md](tasks/active/T257_cloudmini_out_of_capacity_evidence.md) | IN_PROGRESS | Codex | codex/t257-cloudmini-out-of-capacity | Add and run Cloudmini out-of-capacity runtime evidence. |
