...
Current board snapshot on `2026-05-15` after T213 moved to review:
...
| --- | --- | --- | --- | --- | --- |
| T213 | [tasks/active/T213_cloudmini_sandbox_intake.md](tasks/active/T213_cloudmini_sandbox_intake.md) | REVIEW | Codex | codex/t213-cloudmini-sandbox-intake | Record Cloudmini V3 sandbox intake without storing credentials. |
