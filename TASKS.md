...
Current board snapshot on `2026-04-26` after T149 is ready for review:

- `TODO`: 0
- `IN_PROGRESS`: 0
- `REVIEW`: 1
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 145
...
| --- | --- | --- | --- | --- | --- |
| T149 | [tasks/active/T149_humanize_wallet_entry_types.md](tasks/active/T149_humanize_wallet_entry_types.md) | REVIEW | Codex | codex/t149-humanize-wallet-entry-types | Show readable wallet ledger entry labels. |
