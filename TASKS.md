...
Current board snapshot on `2026-04-28` while T180 is in review:
...
| --- | --- | --- | --- | --- | --- |
| T180 | [tasks/active/T180_audit_demo_source_labels.md](tasks/active/T180_audit_demo_source_labels.md) | REVIEW | Codex | codex/t180-audit-demo-source-labels | Humanize audit demo source labels and cover fallback smoke. |
