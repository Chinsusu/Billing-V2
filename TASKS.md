...
Current board snapshot on `2026-05-19` after T277 claimed:
...
| --- | --- | --- | --- | --- | --- |
| T277 | [tasks/active/T277_notification_local_worker_command.md](tasks/active/T277_notification_local_worker_command.md) | IN_PROGRESS | Codex | codex/t277-notification-local-worker | Add local/dev notification delivery worker command without claiming production delivery proof. |
