...
Current board snapshot on `2026-05-16` after T224 started:
...
| --- | --- | --- | --- | --- | --- |
| T224 | [tasks/active/T224_auth_forwarded_host.md](tasks/active/T224_auth_forwarded_host.md) | IN_PROGRESS | Codex | codex/t224-auth-forwarded-host | Resolve auth tenant domains from forwarded host headers behind reverse proxies. |
