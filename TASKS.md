...
Current board snapshot on `2026-04-26` while T143 is in review:

- `TODO`: 0
- `IN_PROGRESS`: 0
- `REVIEW`: 1
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 139
...
| --- | --- | --- | --- | --- | --- |
| T143 | [tasks/active/T143_audit_target_labels.md](tasks/active/T143_audit_target_labels.md) | REVIEW | Codex | codex/t143-audit-target-labels | Use plain frontend labels for audit target types. |
