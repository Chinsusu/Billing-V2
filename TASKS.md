...
Current board snapshot on `2026-05-20` with T281 in progress:
...
| --- | --- | --- | --- | --- | --- |
| T281 | [tasks/active/T281_telegram_failure_retry_drill.md](tasks/active/T281_telegram_failure_retry_drill.md) | IN_PROGRESS | Codex | codex/t281-telegram-failure-retry-drill | Prove Telegram worker retryable and terminal failure classification with a local fake API endpoint. |
