...
Current board snapshot on `2026-04-28` while T181 is in progress:
...
| --- | --- | --- | --- | --- | --- |
| T181 | [tasks/active/T181_alert_demo_source_labels.md](tasks/active/T181_alert_demo_source_labels.md) | IN_PROGRESS | Codex | codex/t181-alert-demo-source-labels | Humanize alert demo source labels and cover smoke guard. |
