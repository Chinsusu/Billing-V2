...
Current board snapshot on `2026-04-26` after T159 was claimed:

- `TODO`: 0
- `IN_PROGRESS`: 1
- `REVIEW`: 0
- `BLOCKED`: 0
- `DONE` task files in `tasks/active/`: 155
...
| --- | --- | --- | --- | --- | --- |
| T159 | [tasks/active/T159_inline_status_label_cleanup.md](tasks/active/T159_inline_status_label_cleanup.md) | IN_PROGRESS | Codex | codex/t159-inline-status-labels | Show readable inline status labels outside badges. |
