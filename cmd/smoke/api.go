...
func apiSmokeChecks() []apiSmokeCheck {
	...
	return []apiSmokeCheck{
		...
		{Name: "admin order list", Path: "/admin/orders", Headers: admin, Contains: []string{`"display_id":42001`, `"buyer_display_id":10002`}},
		{Name: "admin order detail", Path: "/admin/orders/00000000-0000-0000-0000-000000000903", Headers: admin, Contains: []string{`"billing_status":"paid"`, `"buyer_display_id":10002`}},
		...
		{Name: "admin wallet list", Path: "/admin/wallets", Headers: admin, Contains: []string{`"display_id":41001`, `"owner_display_id":10002`}},
		{Name: "admin wallet detail", Path: "/admin/wallets/00000000-0000-0000-0000-000000000901", Headers: admin, Contains: []string{`"currency":"USD"`, `"owner_display_id":10002`}},
