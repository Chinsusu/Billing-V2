...
func apiSmokeChecks() []apiSmokeCheck {
	...
	return []apiSmokeCheck{
		...
		{Name: "admin service public id filter", Path: "/admin/services?display_id=43001&order_display_id=42001&provider_source_display_id=10000", Headers: admin, Contains: []string{`"display_id":43001`}},
		...
		{Name: "admin invoice public id filter", Path: "/admin/invoices?display_id=44001&buyer_display_id=10002&order_display_id=42001", Headers: admin, Contains: []string{`"display_id":44001`}},
