...
func trackedErrorCodeContracts() []errorCodeContract {
	return []errorCodeContract{
		...
		code("order.not_found", source("internal/modules/order/http_errors.go")),
		code("order.status_conflict", source("internal/modules/order/http_errors.go")),
		code("order.status_transition_invalid", source("internal/modules/order/http_errors.go")),
		code("order.idempotency_conflict", source("internal/modules/order/http_errors.go")),
		code("order.provisioning_source_not_found", source("internal/modules/payment/http_handler.go")),
		code("service.not_found", source("internal/modules/order/http_errors.go")),
		code("service.status_invalid", source("internal/modules/order/http_errors.go")),
		code("service.status_conflict", source("internal/modules/order/http_errors.go")),
		code("service.status_transition_invalid", source("internal/modules/order/http_errors.go")),
		code("service.lifecycle_action_invalid", source("internal/modules/order/http_errors.go")),
		code("service.reason_missing", source("internal/modules/order/http_errors.go")),
		code("service.suspension_reason_invalid", source("internal/modules/order/http_errors.go")),
		code("service.billing_cycle_invalid", source("internal/modules/order/http_errors.go")),
		code("service.billing_cycle_value_invalid", source("internal/modules/order/http_errors.go")),
		code("service.renewal_unavailable", source("internal/modules/order/http_errors.go")),
		code("credential.not_found", source("internal/modules/order/http_errors.go")),
		code("credential.reveal_rate_limited", source("internal/modules/order/http_errors.go")),
		code("credential.reveal_denied", source("internal/modules/order/http_errors.go")),
