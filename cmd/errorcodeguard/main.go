...
func trackedErrorCodeContracts() []errorCodeContract {
	return []errorCodeContract{
		...
		code("service.status_conflict", source("internal/modules/order/http_handler.go")),
		code("service.status_transition_invalid", source("internal/modules/order/http_handler.go")),
		code("service.lifecycle_action_invalid", source("internal/modules/order/http_handler.go")),
		code("service.reason_missing", source("internal/modules/order/http_handler.go")),
		code("service.suspension_reason_invalid", source("internal/modules/order/http_handler.go")),
		code("service.billing_cycle_invalid", source("internal/modules/order/http_handler.go")),
		code("service.billing_cycle_value_invalid", source("internal/modules/order/http_handler.go")),
