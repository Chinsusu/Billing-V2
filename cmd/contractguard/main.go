...
func trackedBillingContracts() []routeContract {
	...
	return []routeContract{
		...
		contract("POST", "/reseller/topup-requests/{topup_request_id}/approve", "wallet.topup.approve", nil, []string{"`review_note`", "`ledger_entry_id`", "current reseller tenant"},
			source("internal/modules/wallet/http_handler.go", `"/reseller/topup-requests/"`),
			source("internal/modules/wallet/http_topup_handler.go", "resellerTopupRequestRoute", "handleApproveAdminTopupRequest"),
			source("cmd/api/main.go", "ResellerReviewMiddleware", "PermissionWalletTopupApprove")),
		contract("POST", "/reseller/topup-requests/{topup_request_id}/reject", "wallet.topup.approve", nil, []string{"`review_note`", "current reseller tenant"},
			source("internal/modules/wallet/http_handler.go", `"/reseller/topup-requests/"`),
			source("internal/modules/wallet/http_topup_handler.go", "resellerTopupRequestRoute", "handleRejectAdminTopupRequest"),
			source("cmd/api/main.go", "ResellerReviewMiddleware", "PermissionWalletTopupApprove")),
