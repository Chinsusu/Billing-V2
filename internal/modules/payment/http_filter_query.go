...
func paymentPositiveInt64Query(w http.ResponseWriter, r *http.Request, field string) (int64, bool, bool) {
...
func paymentAmountRangeQuery(w http.ResponseWriter, r *http.Request) (*int64, *int64, bool) {
	minValue, minPresent, ok := paymentNonNegativeInt64Query(w, r, "amount_min")
	if !ok {
		return nil, nil, false
	}
	maxValue, maxPresent, ok := paymentNonNegativeInt64Query(w, r, "amount_max")
	if !ok {
		return nil, nil, false
	}
...
func paymentNonNegativeInt64Query(w http.ResponseWriter, r *http.Request, field string) (int64, bool, bool) {
