...
func auditPositiveInt64Query(w http.ResponseWriter, r *http.Request, field string) (int64, bool, bool) {
	...
	if err != nil {
		httpserver.WriteValidationError(w, r, []httpserver.ValidationField{
			auditValidationField(field, "request.display_id_invalid", "Display id must be a positive number."),
		})
