...
var (
	...
	ErrTopupStatusConflict    = errors.New("wallet top-up status conflict")
	...
	ErrWalletStatusConflict   = errors.New("wallet status conflict")
	...
	ErrReviewNoteMissing      = errors.New("wallet review note missing")
