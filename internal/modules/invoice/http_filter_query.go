...
func invoicePositiveInt64Query(w http.ResponseWriter, r *http.Request, field string) (int64, bool, bool) {
...
func invoiceAmountRangeQuery(w http.ResponseWriter, r *http.Request) (*int64, *int64, bool) {
	minValue, minPresent, ok := invoiceNonNegativeInt64Query(w, r, "amount_min")
	if !ok {
		return nil, nil, false
	}
	maxValue, maxPresent, ok := invoiceNonNegativeInt64Query(w, r, "amount_max")
	if !ok {
		return nil, nil, false
	}
...
func invoiceNonNegativeInt64Query(w http.ResponseWriter, r *http.Request, field string) (int64, bool, bool) {
