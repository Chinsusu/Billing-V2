...
var (
	...
	ErrServiceStatusTransitionInvalid = errors.New("service status transition invalid")
	ErrServiceStatusConflict          = errors.New("service status conflict")
	ErrServiceRenewalUnavailable      = errors.New("service renewal unavailable")
	ErrServiceLifecycleActionInvalid  = errors.New("service lifecycle action invalid")
	ErrServiceLifecycleReasonMissing  = errors.New("service lifecycle reason missing")
