          ...
          <tbody>
            {BANDWIDTH_SERVICES.map((s) => (
              <tr key={s.id} className="hover:bg-gray-50 border-b border-gray-100 last:border-0">
                ...
                <td className="p-4 text-gray-800 max-w-[200px] truncate">{s.label}</td>
                ...
                <td className="p-4 tabular-nums text-gray-600 text-right">{s.usedGB} GB</td>
                <td className="p-4 tabular-nums text-gray-400 text-right">{s.totalGB} GB</td>
                <td className="p-4">
