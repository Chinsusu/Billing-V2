  ...
  return (
    <div className="p-5 flex flex-col gap-4">
      <div className="grid grid-cols-3 gap-4">
        {PRODUCTS.map((p) => (
          <div key={p.sku} className="bg-white border border-gray-200 rounded p-4 flex flex-col gap-3 hover:border-gray-300 transition-colors">
            <div>
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-xl font-bold tabular-nums text-gray-900">{fmtMoney(p.price)}</span>
