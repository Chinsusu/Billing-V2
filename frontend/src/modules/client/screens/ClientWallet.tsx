...
export function ClientWallet() {
  return (
    <div className="p-5 flex flex-col gap-4">
      <div className="bg-white border border-gray-200 rounded p-5 flex items-start justify-between">
        <div>
          <div className="text-[11px] text-gray-400 uppercase tracking-wide mb-1">Available balance</div>
          <div className="text-3xl font-bold tabular-nums text-gray-900">$128.40</div>
      ...
      <div className="bg-white border border-gray-200 rounded">
        <div className="px-4 py-3 border-b border-gray-100">
          <h3 className="text-[13px] font-semibold text-gray-900 m-0">Transaction history</h3>
        </div>
