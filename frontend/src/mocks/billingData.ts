...
export const AUDIT_LOGS: AuditLog[] = [
  ...
  { id: "AUD-70089", ts: "2026-04-22 14:05", level: "error", actor: "system",   actorName: "Provisioning Worker", action: "provisioning.job.stuck",       target: "JOB-3301",    detail: "manual review threshold exceeded",          requestId: "Request not shown", tenantId: "T-0031" },
  ...
  { id: "AUD-70084", ts: "2026-04-22 12:01", level: "info",  actor: "admin",    actorName: "Minh Nguyen",     action: "product.price.updated",        target: "VPS Small plan", detail: "$12→$14/mo, effective next renewal",        requestId: "Request not shown", tenantId: "T-0001" },
  ...
  { id: "AUD-70081", ts: "2026-04-22 10:44", level: "info",  actor: "system",   actorName: "Provisioning Worker", action: "service.provisioned",          target: "SVC-65512",  detail: "Proxy automation VPS active on OVH",        requestId: "Request not shown", tenantId: "T-0031" },
  ...
  { id: "AUD-70078", ts: "2026-04-22 09:01", level: "info",  actor: "reseller", actorName: "ProxyVN",         action: "catalog.price.updated",        target: "Residential Proxy 4G plan", detail: "Markup adjusted from 35%→40%",              requestId: "Request not shown", tenantId: "T-0042" },
  { id: "AUD-70077", ts: "2026-04-21 22:01", level: "info",  actor: "system",   actorName: "Migrator",        action: "db.migration.applied",         target: "RBAC migration", detail: "RBAC migration ran in 1.2s",                requestId: "Request not shown", tenantId: "T-0001" },
  { id: "AUD-70076", ts: "2026-04-21 18:30", level: "warn",  actor: "admin",    actorName: "Minh Nguyen",     action: "auth.login.new_ip",            target: "Session not shown", detail: "Login from 103.21.x.x (Vietnam, new IP)",   requestId: "Request not shown", tenantId: "T-0001" },
];
