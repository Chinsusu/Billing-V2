...
export const AUDIT_LOGS: AuditLog[] = [
  ...
  { id: "AUD-70077", ts: "2026-04-21 22:01", level: "info",  actor: "system",   actorName: "Migrator",        action: "db.migration.applied",         target: "0003",        detail: "RBAC migration ran in 1.2s",                requestId: "Request not shown", tenantId: "T-0001" },
