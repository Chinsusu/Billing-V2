...
export function KpiCard({ label, value, delta, sub }: KpiCardProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded p-4 flex flex-col gap-4 min-w-0">
      <div className="text-[11px] font-medium text-gray-400 uppercase tracking-wide">{label}</div>
      <div className="text-[22px] font-medium tracking-tight text-gray-900 tabular-nums">{value}</div>
